...
<div class="container">
	...
	<c:if test="${cart.totalItems == 0}">
		<div class="row">
			<div class="col text-center"><h4 class="alert alert-warning">There's no items in your cart</h4></div>
		</div>		
	</c:if>
				...
				<div class="card-body">
					<form action="place_order" method="post">
						<div class="form-group row">
							...
							<div class="col-sm-9"><input type="text" name="firstname" value="${loggedCustomer.firstname}" required minlength="3" maxlength="30" class="form-control" /></div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Last Name:</label>
							<div class="col-sm-9"><input type="text" name="lastname" value="${loggedCustomer.lastname}" required minlength="3" maxlength="30" class="form-control"/></div>
						</div>						
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Phone:</label>
							<div class="col-sm-9"><input type="text" name="phone" value="${loggedCustomer.phone}" required minlength="9" maxlength="15" class="form-control"/></div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Address Line 1:</label>
							<div class="col-sm-9"><input type="text" name="address1" value="${loggedCustomer.addressLine1}" required minlength="10" maxlength="256" class="form-control" /></div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Address Line 2:</label>
							<div class="col-sm-9"><input type="text" name="address2" value="${loggedCustomer.addressLine2}" required minlength="10" maxlength="256" class="form-control"/></div>
						</div>						
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">City:</label>
							<div class="col-sm-9"><input type="text" name="city" value="${loggedCustomer.city}" required minlength="3" maxlength="32" class="form-control"/></div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">State:</label>
							<div class="col-sm-9"><input type="text" name="state" value="${loggedCustomer.state}" required minlength="3" maxlength="45" class="form-control" /></div>
						</div>												
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Zip Code:</label>
							<div class="col-sm-9"><input type="text" name="zipcode" value="${loggedCustomer.zipcode}" required minlength="3" maxlength="24" class="form-control"/></div>
						</div>						
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-sm-5 col-form-label">Choose your payment method:</label>
							<div class="col-sm-7">
