...
<div class="container">
	...
	<form id="reviewForm" style="max-width: 900px; margin: 0 auto">
		<div class="row">
			<div class="col text-center"><h3 class="alert alert-info">You already wrote a review for this book</h3></div>
		</div>
		<div class="row">
